...
export function getFeaturedItems(
  ...
  const NEIGHBOURS: Partial<Record<Scenario, Scenario[]>> = {
    hosting:      ["tea_break", "general", "cooking", "snacks", "dairy"],
    ...
    power_cut:    ["travel", "general", "electronics"],
    school:       ["general", "home_repair", "office"],
    tea_break:    ["hosting", "general", "snacks", "dairy"],
    ...
    party:        ["gifting", "snacks", "dairy", "frozen_food"],
    pet_care:     ["general", "cleaning"],
    fitness:      ["general", "breakfast", "dairy", "staples"],
    cleaning:     ["personal_care", "general", "home_repair"],
    breakfast:    ["dairy", "staples", "general", "snacks"],
    ...
    snacks:       ["tea_break", "hosting", "general", "instant_food"],
