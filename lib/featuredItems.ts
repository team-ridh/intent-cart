...
export function getFeaturedItems(
  ...
  const NEIGHBOURS: Partial<Record<Scenario, Scenario[]>> = {
    hosting:    ["tea_break", "general", "cooking"],
    fever:      ["general", "travel"],
    pooja:      ["general", "cooking"],
    rainy:      ["tea_break", "general", "cooking"],
    travel:     ["general", "power_cut"],
    power_cut:  ["travel", "general"],
    school:     ["general", "home_repair"],
    tea_break:  ["hosting", "general"],
    general:    ["cooking", "tea_break", "hosting"],
    cooking:    ["general", "hosting"],
    home_repair:["general", "school"],
  };
